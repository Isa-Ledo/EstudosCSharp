...
using VendaDeCarroEstudo.BancoDeDados;
...
namespace VendaDeCarroEstudo
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var primeiroCarroDalista = carroRepositorio.BuscarTodosOsCarros().FirstOrDefault();
            primeiroCarroDalista.Quantidade = 100;
            carroRepositorio.AtualizaCarro(primeiroCarroDalista);
